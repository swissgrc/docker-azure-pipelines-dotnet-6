...
| unstable   | Latest unstable release (from `develop` branch)                                                 | debian:11.6-slim | 20.10.22   | 6.0.404  | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dotnet/unstable?style=flat-square)  |
