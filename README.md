...
| 6-unstable | Latest unstable release (from `develop` branch)                                                 | azure-pipelines-git:2.45.2 | 6.0.423  | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dotnet/6-unstable?style=flat-square) |
