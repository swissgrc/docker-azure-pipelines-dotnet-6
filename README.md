...
| unstable   | Latest unstable release (from `develop` branch)                                                 | azure-pipelines-git:2.39.2 | 6.0.408  | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dotnet/unstable?style=flat-square)  |
