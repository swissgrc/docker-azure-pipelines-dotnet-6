...
| unstable   | Latest unstable release (from `develop` branch)                                                 | debian:11.6-slim | 23.0.1     | 6.0.405  | 1:2.39.2-1~bpo11+1   | 3.3.0   | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dotnet/unstable?style=flat-square)  |
