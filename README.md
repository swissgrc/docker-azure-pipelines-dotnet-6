...
| unstable   | Latest unstable release (from `develop` branch)                                                 | debian:11.5-slim | 20.10.19   | 6.0.402  | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dotnet/unstable?style=flat-square)  |
