...
| 6-unstable | Latest unstable release (from `develop` branch)                                                 | azure-pipelines-git:2.44.0 | 6.0.419  | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dotnet/6-unstable?style=flat-square) |
