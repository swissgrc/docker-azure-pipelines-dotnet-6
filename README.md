...
| unstable   | Latest unstable release (from `develop` branch)                                               | debian:11.4-slim | 20.10.17   | 6.0.400  | ![Docker Image Size (tag)](https://img.shields.io/docker/image-size/swissgrc/azure-pipelines-dotnet/unstable?style=flat-square)  |
